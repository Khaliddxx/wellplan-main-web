...
const features = [
  ...
  },
  {
    ...
    visual: (
      <div className="relative w-full h-full">
        {/* Workflow Canvas */}
        <div className="absolute inset-1 sm:inset-4 bg-[#0f1115] rounded-2xl border border-white/10 overflow-hidden shadow-2xl p-2 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-1 sm:gap-0">
            {/* Trigger */}
            <motion.div 
              className="w-full sm:w-20 lg:w-24 h-12 sm:h-20 lg:h-24 bg-purple-500/20 border border-purple-500/50 rounded-xl flex flex-row sm:flex-col items-center justify-center sm:justify-center gap-2 sm:gap-0 px-3 sm:px-0"
              animate={{ scale: [1, 1.05, 1] }}
              transition={{ duration: 2, repeat: Infinity }}
            >
              <span className="text-lg sm:text-2xl">📧</span>
              <span className="text-[9px] sm:text-[10px] text-purple-400 sm:mt-1">Trigger</span>
            </motion.div>
            
            {/* Arrow - vertical on mobile */}
            <motion.div 
              className="w-0.5 h-2 sm:w-auto sm:h-0.5 sm:flex-1 bg-gradient-to-b sm:bg-gradient-to-r from-purple-500 to-pink-500 sm:mx-2"
              animate={{ opacity: [0.5, 1, 0.5] }}
              transition={{ duration: 1.5, repeat: Infinity }}
            />
            
            {/* Wait */}
            <div className="w-full sm:w-20 lg:w-24 h-12 sm:h-20 lg:h-24 bg-white/5 border border-white/10 rounded-xl flex flex-row sm:flex-col items-center justify-center sm:justify-center gap-2 sm:gap-0 px-3 sm:px-0">
              <span className="text-lg sm:text-2xl">⏰</span>
              <span className="text-[9px] sm:text-[10px] text-gray-400 sm:mt-1">Wait 2 days</span>
            </div>
            
            {/* Arrow */}
            <motion.div 
              className="w-0.5 h-2 sm:w-auto sm:h-0.5 sm:flex-1 bg-gradient-to-b sm:bg-gradient-to-r from-pink-500 to-orange-500 sm:mx-2"
              animate={{ opacity: [0.5, 1, 0.5] }}
            ...
            {/* SMS */}
            <motion.div 
              className="w-full sm:w-20 lg:w-24 h-12 sm:h-20 lg:h-24 bg-pink-500/20 border border-pink-500/50 rounded-xl flex flex-row sm:flex-col items-center justify-center sm:justify-center gap-2 sm:gap-0 px-3 sm:px-0"
              animate={{ scale: [1, 1.05, 1] }}
              transition={{ duration: 2, repeat: Infinity, delay: 1 }}
            >
              <span className="text-lg sm:text-2xl">💬</span>
              <span className="text-[9px] sm:text-[10px] text-pink-400 sm:mt-1">Send SMS</span>
            </motion.div>
          </div>
          
          {/* Stats below */}
          <div className="mt-3 sm:mt-8 grid grid-cols-3 gap-1 sm:gap-4">
            <div className="bg-white/5 rounded-lg p-1.5 sm:p-3 text-center">
              <div className="text-sm sm:text-xl font-bold text-purple-400">1,234</div>
              <div className="text-[7px] sm:text-[10px] text-gray-500">Sequences</div>
            </div>
            <div className="bg-white/5 rounded-lg p-1.5 sm:p-3 text-center">
              <div className="text-sm sm:text-xl font-bold text-pink-400">89%</div>
              <div className="text-[7px] sm:text-[10px] text-gray-500">Delivery</div>
            </div>
            <div className="bg-white/5 rounded-lg p-1.5 sm:p-3 text-center">
              <div className="text-sm sm:text-xl font-bold text-orange-400">4.2x</div>
              <div className="text-[7px] sm:text-[10px] text-gray-500">ROI</div>
            </div>
          </div>
        </div>
      </div>
